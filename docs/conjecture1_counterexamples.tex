...
\hypersetup{pdftitle={Exact qutrit counterexamples to Conjecture 1 of Das and Mori},pdfauthor={Dehao Lin},pdfsubject={Communication derivative of the frozen v0.1 manuscript; no new claim}}
\begin{document}
\begin{center}
{\Large\bfseries Exact qutrit counterexamples to Conjecture 1\\[3pt]of Das and Mori}\par
\vspace{4pt}
Dehao Lin\\
...
\subsection*{A. Lower-side counterexample}
\[
...
\newpage
\subsection*{B. Upper-side counterexample}
\[
...
\subsection*{Minimality and scope}
...
{\small This note is a communication derivative of the full manuscript
\emph{Exact limits of Krylov-complexity comparisons under purification}.
