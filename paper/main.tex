...
\date{}
\hypersetup{pdftitle={Exact limits of Krylov-complexity comparisons under purification},pdfauthor={Dehao Lin},pdfsubject={Public v0.1.2 release; authoritative V3 scientific freeze}}
\begin{document}
\maketitle
\begin{abstract}
...
\input{sections/03_hierarchy}
\input{sections/04_factor_two}
\input{sections/05_ratios}
\input{sections/06_survivors}
\input{sections/07_discussion}
\appendix
\input{sections/appendix_certificates}
\input{sections/appendix_bounds}
