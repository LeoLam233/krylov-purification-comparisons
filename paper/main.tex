...
\date{}
\hypersetup{pdftitle={Exact limits of Krylov-complexity comparisons under purification},pdfauthor={Dehao Lin},pdfsubject={Public v0.1 release; authoritative V3 scientific freeze}}
\begin{document}
\maketitle
\begin{abstract}
