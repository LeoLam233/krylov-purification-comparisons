# AI contribution statement and research workflow

The historical filename is retained for compatibility with the unchanged paper checker.
The disclosure is supplied and approved for this release; no disclosure TODO remains.
...
The paper author line contains only Dehao Lin; Git co-author attribution is separate.
The manuscript disclosure names no individual AI products or models.
